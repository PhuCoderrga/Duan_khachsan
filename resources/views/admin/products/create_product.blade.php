    ...
    <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input id="product_name" name="name" value="{{old('name')}}" placeholder="--Tên sản phẩm mới--"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input id="available_quantity" name="price" placeholder="--Giá cho sản phẩm--"
                        class="form-control input-md" required="" type="text" value="{{old('price')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input id="product_weight" name="price_discount" placeholder="--Giá giảm--"
                        class="form-control input-md" required="" type="text" value="{{old('price_discount')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input id="product_weight" name="desc_short" placeholder="--Mô tả ngắn về sản phẩm--"
                        class="form-control input-md" required="" type="text" value="{{old('desc_short')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <textarea class="form-control" rows="4" cols="50" id="product_description"
                        name="desc_long">{{old('desc_long')}}</textarea>
                </div>
            </div>
            <!-- Text input-->
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-md-3">
                                <input type='file' id="readUrl" name="feature_img" class="input-file">
                            </div>
                            <div class="col-md-4">
                                <img class="img-fluid" id="uploadedImage" alt="Uploaded Image" style="display:none;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-12 text-center">
                        <button id="singlebutton" class="btn btn-success w-50">Thêm Sản Phẩm
                            Mới</button>
                    </div>
                </div>
            </div>
