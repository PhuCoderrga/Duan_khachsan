        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12 d-flex justify-content-center">
                    <input id="product_name" name="name" value="{{old('name')}}" placeholder="--Tên danh mục mới--"
                        class="form-control w-75" required="" type="text">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12 d-flex justify-content-center">
                    <input id="product_weight" name="desc_short" placeholder="--Mô tả ngắn về danh mục--"
                        class="form-control w-75" required="" type="text" value="{{old('desc_short')}}">
            ...
            <div class="form-group">
                <div class="col-md-12 text-center">
                    <button id="singlebutton" class="btn btn-success w-50">Thêm Danh Mục
                        Mới</button>
                </div>
            </div>
        </fieldset>
